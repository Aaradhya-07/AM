...
export function createServer() {
    ...
    server.registerTool("audit_system", {
    ...
    server.registerTool("explain_finding", {
        ...
        const finding = fixture.findings.find((candidate) => candidate.id === findingId) ??
            fixture.findings[0];
        const payload = {
            finding,
            explanation: "Fixture explanation only. Production reasoning is intentionally not implemented.",
        };
        return {
