...
export const IdSchema = z
    ...
    .regex(ID_PATTERN, "an id must start alphanumerically and contain only letters, digits, '.', '_' or '-'");
...
export const RelativePathSchema = z
    ...
    message: "paths in a portable contract must be relative; absolute local paths are machine-identifying",
})
    .refine((value) => !/^[A-Za-z]:[\\/]/.test(value), {
    message: "paths in a portable contract must be relative; drive-qualified paths are machine-identifying",
});
/**
...
export const DataClassificationSchema = z
    .string()
    .min(1)
    .regex(/^[a-z0-9][a-z0-9_]*$/, "a data classification must be lower_snake_case");
