...
import { DeterminismSchema, IdSchema, NonEmptyStringSchema, OutcomeSchema, RefSchema, TimestampSchema, } from "./primitives.js";
...
export const ModelSchema = z
    ...
    .refine((value) => value.version !== null || value.version_mutability === "floating", {
    message: "a model without an exact version must declare version_mutability: floating as an explicit mutability warning",
    path: ["version"],
});
/**
...
export const EstimatesSchema = z
    ...
    .refine((value) => (value.tokens_per_call === null &&
    value.latency_p95_ms === null &&
    value.monthly_effective_cost_usd === null) ||
    value.basis !== null ||
    value.assumptions.length > 0, {
    message: "an estimate must record its basis or assumptions; an unexplained number is not usable evidence",
    path: ["basis"],
});
/**
